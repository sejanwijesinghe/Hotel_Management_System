...
namespace HotelManagementSystem {
    ...
    public partial class HotelManagementSystemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Email, string PhoneNumber, string Address, string Nationality, string IDNumber) {
...
namespace HotelManagementSystem.HotelManagementSystemDataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([FirstName], [LastName], [Email], [PhoneNumber], [Address], [Nationality], [IDNumber]) VALUES (@FirstName, @LastName, @Email, @PhoneNumber, @Address, @Nationality, @IDNumber);
SELECT CustomerID, FirstName, LastName, Email, PhoneNumber, Address, Nationality, IDNumber FROM Customers WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [Address] = @Address, [Nationality] = @Nationality, [IDNumber] = @IDNumber WHERE (([CustomerID] = @Original_CustomerID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Nationality = 1 AND [Nationality] IS NULL) OR ([Nationality] = @Original_Nationality)) AND ((@IsNull_IDNumber = 1 AND [IDNumber] IS NULL) OR ([IDNumber] = @Original_IDNumber)));
SELECT CustomerID, FirstName, LastName, Email, PhoneNumber, Address, Nationality, IDNumber FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName, Email, PhoneNumber, Address, Nationality," +
                " IDNumber FROM dbo.Customers";
        ...
        public virtual int Fill(HotelManagementSystemDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual HotelManagementSystemDataSet1.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelManagementSystemDataSet1.CustomersDataTable dataTable = new HotelManagementSystemDataSet1.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelManagementSystemDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_Email, string Original_PhoneNumber, string Original_Address, string Original_Nationality, string Original_IDNumber) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Email, string PhoneNumber, string Address, string Nationality, string IDNumber) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string PhoneNumber, string Address, string Nationality, string IDNumber, int Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_Email, string Original_PhoneNumber, string Original_Address, string Original_Nationality, string Original_IDNumber) {
            return this.Update(FirstName, LastName, Email, PhoneNumber, Address, Nationality, IDNumber, Original_CustomerID, Original_FirstName, Original_LastName, Original_Email, Original_PhoneNumber, Original_Address, Original_Nationality, Original_IDNumber, Original_CustomerID);
        }
    }
